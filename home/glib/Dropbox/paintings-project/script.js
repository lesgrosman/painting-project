...
function forms() {
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      Object(_services_services__WEBPACK_IMPORTED_MODULE_4__["default"])('http://localhost:3000/requests', json).then(function (data) {
        console.log(data);
...
function modals() {
  ...
  function bindModal(openSelector, modalSelector, closeSelector) {
    var openModal = document.querySelectorAll(openSelector),
...
/* harmony default export */ __webpack_exports__["default"] = (sizePicture);
